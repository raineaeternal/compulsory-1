    ...
    <>
      <div className="flex flex-row align-middle mx-auto w-full items-center justify-between bg-inherit bg-blend-darken top-0 fixed">
        ...
        <div className="flex space-x-4 text-[#ffffff] pr-5">
          ...
          <Link className="bg-primary pt-2 pb-2 pr-4 pl-4 rounded-[8px] transition-all ease-in-out duration-200 outline-4 outline outline-primary/0 hover:outline-primary/100 hover:bg-primary/10" href="/smash">Smash</Link>   
